...
const pairs = [
  ...
  ["settings-overlay.json", path.join(repoRoot, "settings-overlay.json"), path.join(repoRoot, "plugin", "settings-overlay.json")],
  ["verbs/zh-CN.json", path.join(repoRoot, "verbs", "zh-CN.json"), path.join(repoRoot, "plugin", "verbs", "zh-CN.json")],
  ["tips/zh-CN.json", path.join(repoRoot, "tips", "zh-CN.json"), path.join(repoRoot, "plugin", "tips", "zh-CN.json")],
