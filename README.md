...
| `powershell -File install.ps1` | Windows PowerShell 安装（旧 npm cli.js 为 stable；Windows x64 native `2.1.113 - 2.1.177` 为 experimental，需要 `node-lief`） | `stable / experimental`（需 PowerShell 5.1+） |
