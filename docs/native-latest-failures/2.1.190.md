# macOS native latest candidate failure: 2.1.190
...
```markdown
# Upstream text diff: 2.1.185 -> 2.1.190

- Added upstream strings: 6724
- Removed upstream strings: 5820
- Already covered by translations: 50
- Needs translation review: 6674
- Sensitive review hints: 136
...
- , diff: ${...}
- , errors=[${...}]
- ,_;if(t[4]!==g)_=Ju.createElement(w,{color:g},
- ,_]:m.getSpawnArgs(_),H=await m.getEnvironmentOverrides(e,u),I=!!c,P=d9(
- ,_=CQ(),y=e===
- ,_Am=
- ,_n=It+Et.id+(Zt?
- ,_oo[e],
- ,_Vt.createElement(w,{bold:!0},
- ,:()]+/g,
- ,!0),b_tmpl:new $t(
- ,!0),q_tmpl:new $t(
- ,!0))de=!0;if(!vle.test(ae=s()))throw T(ae);if(pe=ae,l(
- ,!0))fe=!0;if(!vle.test(ae=s()))throw T(ae);_e=ae,l(
- ,!0))throw Oe(
- ,!0)}else{if(he)he();if(l(
- ,!1),b_expr:new $t(
- ,!1),p_expr:new $t(
- ,!1),p_stat:new $t(
- ,!1);else if(!s.sso_session)throw new VKe.TokenProviderError(
- ,!1);for(let A of["sso_start_url","sso_region"])if(!l[A])throw new VKe.TokenProviderError(
- ,!1))return!1;return bc(
- ,..._Ap(o,e)}}let n=hoo().haiku,r=await i4e(e,n);if(r.ok)return{status:
- ,...At===
- ... 5780 more
```
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.190 --skip-latest --native-macos-arm64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.190 --native-macos-arm64
