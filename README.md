...
[![macOS native](https://img.shields.io/badge/macos%20native-2.1.113--2.1.223-green)](./docs/support-matrix.md)
...
| macOS · native binary（arm64） | `2.1.113 - 2.1.223` 内的已验证版本 | 需要 `node-lief`；个别版本未收录，见支持矩阵 |
