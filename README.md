...
- ✅ 在已验证版本上 patch 硬编码文字（1893 条翻译；代表版本 `2.1.112` 实测 1595 处有效 patch）
...
| UI 文字中文化 | 1893 条翻译，`2.1.112` 实测 1595 处有效 patch | CLI Patch（扫描真实双引号字符串 token 后逐条替换）+ 显示面审计 |
