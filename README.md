...
- ✅ 在支持的安装方式上 patch 硬编码文字（1571 条翻译；当前 stable 代表版本 `2.1.112` 实测 1448 处有效 patch）
...
| UI 文字中文化 | 1571 条翻译，`2.1.112` 实测 1448 处有效 patch | CLI Patch（扫描真实双引号字符串 token 后逐条替换） |
...
├── cli-translations.json    ← 1571 条 UI 翻译对照表
