...
| macOS native binary | 2.1.113 - 2.1.159 (不含未纳入本轮支持的 2.1.115, 2.1.125, 2.1.127, 2.1.130, 2.1.134, 2.1.135, 2.1.147, 2.1.149, 2.1.151, 2.1.154, 2.1.155, 2.1.157) | experimental | native + 显示审计已验证 | 只用已验证版本 |
