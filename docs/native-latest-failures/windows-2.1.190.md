# Windows native latest candidate failure: 2.1.190

- Run: https://github.com/taekchef/claude-code-zh-cn/actions/runs/28119250156
...
```markdown
# Upstream text diff: 2.1.183 -> 2.1.190

- Added upstream strings: 6625
- Removed upstream strings: 5721
- Already covered by translations: 50
- Needs translation review: 6575
...
```bash
node scripts/verify-upstream-compat.js --baseline 2.1.190 --skip-latest --native-windows-x64 --json
node scripts/generate-upstream-text-diff.js --to 2.1.190 --native-windows-x64
